...
project = u'Metatlas'
copyright = u'2015 - {today.year}, Metatlas contributors'.format(today=datetime.date.today())
...
version = metatlas.__version__
# The full version, including alpha/beta/rc tags.
release = metatlas.__version__
...
latex_documents = [
  ('index', 'Metalas.tex', u'Metatlas Documentation',
   u'Metatlas contributors', 'manual'),
]
...
man_pages = [
    ('index', 'Metatlas', u'Metatlas Documentation',
     [u'Metatlas contributors'], 1)
]
...
texinfo_documents = [
  ('index', 'Metatlas', u'Metatlas Documentation',
   u'Metatlas contributors', 'Metatlas', 'Atlas for Metabolites',
   'Miscellaneous'),
]
