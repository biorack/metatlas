...
def make_stats_table(input_fname: Optional[Path] = None, input_dataset = [], msms_hits_df = None,
    ...
    with pd.ExcelWriter(excel_path, engine='xlsxwriter') as writer:
        ...
        HEADER2 = ['Compound #','Identified Metabolite','Name of metabolite searched for','Labels of Overlapping Compounds','Inchi Keys of Overlapping Compounds','Molecular Formula','Polarity','Exact Mass','Inchi Key','MSMS Score (0 to 1)','m/z score (0 to 1)','RT score (0 to 1)','Total ID Score (0 to 3)','Mass Spec Inititative Identification Level','Isomer details','Identification notes','MS1 notes', 'MS2 notes','Maximum MS1 intensity across all files','Filename w/ maximum MS1','Retention time of max intensity MS1 peak','File with highest MSMS match score','RT of highest matched MSMS scan','Number of ion matches in msms spectra to EMA reference spectra','List of ion matches in msms spectra to EMA reference spectra','Ratio of MSMS fragment matches to total reference fragments','Jaccard distance between query and reference MSMS spectral peaks','','Adduct','Theoretical m/z','Measured m/z','mass error (delta Da)','mass error (delta ppm)','Minimum retention time (min)','Maximum retention time (max)','Theoretical retention time (peak)','Detected RT (peak)','RT error (absolute delta)']
