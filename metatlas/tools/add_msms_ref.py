...
class MsmsRef(HasTraits):
    ...
    def _valid_inchi(self, proposal: Proposal) -> str:
        ...
        if not filtering.filter_utils.smile_inchi_inchikey_conversions.is_valid_inchi(new_value):
    ...
    def _valid_smiles(self, proposal: Proposal) -> str:
        ...
        new_value = str(proposal["value"])
        if not filtering.filter_utils.smile_inchi_inchikey_conversions.is_valid_smiles(new_value):
