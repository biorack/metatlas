...
ADDUCTS = ('', '[2M+ACN+H]+', '[2M+ACN+Na]+', '[2M+FA-H]-', '[2M+H]+', '[2M+Hac-H]-', '[2M+K]+', '[2M+NH4]+', '[2M+Na]+', '[2M-2H+Na]-', '[2M-H]-', '[3M-H]-', '[M+2ACN+2H]2+', '[M+2ACN+H]+', '[M+2H+Na]3+', '[M+2H]2+', '[M+2K-H]+', '[M+2Na-H]+', '[M+2Na]2+', '[M+3ACN+2H]2+', '[M+3H]3+', '[M+3Na]3+', '[M+ACN+2H]2+', '[M+ACN+H]+', '[M+ACN+Na]+', '[M+Br]-', '[M+CH3COO]-', '[M+CH3OH+H]+', '[M+Cl]-', '[M+DMSO+H]+', '[M+FA-H]-', '[M+H+2Na]3+', '[M+H+K]2+', '[M+H+NH4]2+', '[M+H+Na]2+', '[M+H-CH3NH2]+', '[M+H-H2O]+', '[M+H-H2O]2+', '[M+H-NH3]+', '[M+H]+', '[M+H]2+', '[M+Hac-H]-', '[M+IsoProp+H]+', '[M+IsoProp+Na+H]+', '[M+K-2H]-', '[M+K]+', '[M+K]2+', '[M+NH4]+', '[M+Na-2H]-', '[M+Na]+', '[M+OAc]-', '[M+TFA-H]-', '[M+acetate]-', '[M+formate]-', '[M-2H2O+H]+', '[M-2H]-', '[M-2H]2-', '[M-3H]3-', '[M-CH3]-', '[M-H+2Na]+', '[M-H+Cl]-', '[M-H+Cl]2-', '[M-H+Na]+', '[M-H-CO2-2HF]-', '[M-H2O+H]+', '[M-H2O-H]-', '[M-H]-', '[M-e]+', '[M]+', '[M]-', '[M+HCOO]-')
