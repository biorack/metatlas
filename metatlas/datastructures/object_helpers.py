...
class Workspace(object):
    ...
    def save_objects(self, objects, _override=False):
        ...
        try:
            ...
            db.commit()
            logger.info('Exiting Workspace.save_objects')
        except Exception as err:
            rollback_and_log(db, err)
        finally:
