...
"""
    ...
    expected_df[str(tmp_path / "505892_OakGall_final/0/Targeted/Test-QC/QC-POS/POS_QC_Measured_RTs.csv")] = {
        ...
        "mean": {0: 1.884768, 1: 2.289462, 2: 2.660572, 3: 2.769523, 4: 3.110135, 5: 4.878624, 6: 13.32883},
        "median": {0: 1.884217, 1: 2.293711, 2: 2.664679, 3: 2.770917, 4: 3.109064, 5: 4.878586, 6: 13.32883},
        "min": {0: 1.878133, 1: 2.24759, 2: 2.59303, 3: 2.747974, 4: 3.075452, 5: 4.836015, 6: 13.31463},
        "max": {0: 1.892506, 1: 2.322836, 2: 2.719899, 3: 2.788285, 4: 3.146962, 5: 4.921309, 6: 13.34303},
        "standard deviation": {
            0: 0.007206614,
            1: 0.03438155,
            2: 0.06117022,
    ...
    assert utils.num_files_in(tmp_path) == 22
